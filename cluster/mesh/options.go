...
const (
	defaultNameKey      = "cluster.mesh.name"
	defaultCodecKey     = "cluster.mesh.codec"
	defaultTimeoutKey   = "cluster.mesh.timeout"
	defaultEncryptorKey = "cluster.mesh.encryptor"
	defaultDecryptorKey = "cluster.mesh.decryptor"
)
