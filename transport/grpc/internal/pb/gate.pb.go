...
func (x *StatReply) Reset() {
	*x = StatReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gate_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StatReply) Descriptor() ([]byte, []int) {
	return file_gate_proto_rawDescGZIP(), []int{15}
}
...
var file_gate_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0x00, 0x12, 0x28, 0x0a, 0x04, 0x53, 0x74, 0x61, 0x74, 0x12, 0x0f, 0x2e, 0x70, 0x62, 0x2e,
	0x53, 0x74, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x70, 0x62,
	0x2e, 0x53, 0x74, 0x61, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x0a,
	...
	0x74, 0x1a, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
...
var file_gate_proto_goTypes = []interface{}{
	...
	(*StatRequest)(nil),       // 14: pb.StatRequest
	(*StatReply)(nil),         // 15: pb.StatReply
	(*Message)(nil),           // 16: pb.Message
}
var file_gate_proto_depIdxs = []int32{
	16, // 0: pb.PushRequest.Message:type_name -> pb.Message
	16, // 1: pb.MulticastRequest.Message:type_name -> pb.Message
	16, // 2: pb.BroadcastRequest.Message:type_name -> pb.Message
	...
	8,  // 6: pb.Gate.Push:input_type -> pb.PushRequest
	10, // 7: pb.Gate.Multicast:input_type -> pb.MulticastRequest
	12, // 8: pb.Gate.Broadcast:input_type -> pb.BroadcastRequest
	14, // 9: pb.Gate.Stat:input_type -> pb.StatRequest
	6,  // 10: pb.Gate.Disconnect:input_type -> pb.DisconnectRequest
	1,  // 11: pb.Gate.Bind:output_type -> pb.BindReply
	3,  // 12: pb.Gate.Unbind:output_type -> pb.UnbindReply
	5,  // 13: pb.Gate.GetIP:output_type -> pb.GetIPReply
	...
	15, // 17: pb.Gate.Stat:output_type -> pb.StatReply
	7,  // 18: pb.Gate.Disconnect:output_type -> pb.DisconnectReply
...
func file_gate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gate_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
